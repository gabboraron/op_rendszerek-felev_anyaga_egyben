  ...
  for (idx = 0; idx < nrOfJobs; ++idx)
  {
    ...
    {                // child process
         ...
         printf("Gyerek elkezdi olvasni a csobol az adatokat!\n");
             ...
             read(pipefd[0],current_nr,sizeof(current_nr)); //
         ...
         write(pipefc[1], done, sizeof(done));
         close(pipefc[1]);
    ...
    {    // szulo process
         ...
         write(pipefd[1], current_nr, sizeof(current_nr));               //ezt akarjuk eljküldeni a csővezetékben, karakterszám + végkarakter
